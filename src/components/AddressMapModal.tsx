...
export default function AddressMapModal({
  ...
  // URLs de navegação para técnicos em campo
  ...
  const osmEmbedUrl = `https://www.openstreetmap.org/export/embed.html?bbox=${lng - 0.005}%2C${lat - 0.0035}%2C${lng + 0.005}%2C${lat + 0.0035}&layer=mapnik&marker=${lat}%2C${lng}`;
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-900/60 backdrop-blur-xs animate-in fade-in">
      ...
      >
        ...
        <div className="p-5 sm:p-6 border-b border-slate-200 bg-slate-50/70 flex items-center justify-between">
          ...
          <button
            onClick={onClose}
            className="w-8 h-8 rounded-full border border-slate-200 hover:bg-slate-200 text-slate-500 hover:text-slate-800 flex items-center justify-center transition-colors"
          >
            ✕
          </button>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-5">
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-2xl p-4">
            ...
            {cepError && (
              <div className="mt-2.5 p-2 bg-red-50 border border-red-200 rounded-xl flex items-center gap-2 text-xs text-red-800">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <div className="sm:col-span-2">
                    ...
                    <input 
                      ...
                      className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800 focus:bg-white focus:outline-none focus:border-blue-600"
                    />
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      placeholder="SP"
                      maxLength={2}
                      className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800 uppercase focus:bg-white focus:outline-none focus:border-blue-600"
                    />
                  </div>
                </div>
            ...
            <div className="space-y-3">
              <div className="bg-gradient-to-br from-emerald-500/10 via-emerald-500/5 to-transparent border border-emerald-200 rounded-2xl p-4 shadow-2xs">
                <div className="flex items-center gap-2 mb-2.5">
                  ...
                  <div>
                    <h4 className="font-bold text-sm text-slate-900 font-outfit">Enviar para o Técnico</h4>
              ...
              <div className="border border-slate-200 rounded-2xl p-3.5 bg-white space-y-2">
                ...
                <a
                  ...
                  className="w-full py-2 px-3 bg-blue-50 hover:bg-blue-100/80 border border-blue-200 text-blue-700 rounded-xl text-xs font-bold flex items-center justify-between transition-colors"
                >
                ...
                >
                  <span className="flex items-center gap-2">
                    <Car size={14} /> Abrir Rota no Waze
                  </span>
                  <ExternalLink size={13} />
                </a>
              </div>
          ...
          <div className="border border-slate-200 rounded-2xl overflow-hidden bg-white shadow-sm">
            <div className="p-3 bg-slate-50 border-b border-slate-200 flex flex-wrap items-center justify-between gap-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-bold text-slate-800">Visualização de Satélite / Ruas</span>
            ...
            {/* Container do Iframe / Mapa Interativo */}
