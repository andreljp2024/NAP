  ...
  if (variant === 'topbar') {
    ...
    return (
      <div className={`relative ${className}`} ref={popoverRef}>
        ...
        {isOpen && (
          <div className="absolute right-0 mt-2 w-96 rounded-2xl bg-[#0e1422] border border-white/10 shadow-2xl p-4 z-50 text-slate-200 animate-in fade-in zoom-in-95 duration-150">
            {/* Header do Popover */}
