...
export default function PortalIncidenteDetalheModal({
  ...
  const handleAtivarAviso = () => {
    ...
    setTimeout(() => {
      alert("Pronto! Você receberá uma notificação instantânea via WhatsApp e Push assim que as fusões forem concluídas e o concentrador normalizado.");
    }, 150);
  };
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in">
      <div className="bg-[#101726] border border-amber-500/20 rounded-3xl w-full max-w-lg p-6 shadow-2xl relative overflow-hidden flex flex-col">
        ...
        <div className="pt-4 mt-4 border-t border-white/5 flex items-center justify-between gap-3 relative z-10">
          <button
