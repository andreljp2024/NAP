    ...
    <div className="space-y-4">
      ...
      {currentLogoUrl && (
        <div className="bg-slate-950 border border-white/5 rounded-2xl p-4 space-y-3">
          ...
          {fileInfo && (
            <div className="text-[11px] text-slate-400 flex items-center gap-2 bg-white/5 px-2.5 py-1 rounded-lg">
              <span className="font-semibold text-white truncate max-w-[200px]">{fileInfo.name}</span>
              <span>•</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div className="p-3 rounded-xl bg-[#060b14] border border-white/10 flex flex-col items-center justify-center gap-2 min-h-[90px]">
              <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">No Tema Escuro (Landing & Admin)</span>
            ...
            <div className="p-3 rounded-xl bg-white border border-slate-200 flex flex-col items-center justify-center gap-2 min-h-[90px]">
              <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">No Tema Claro (Portal PWA)</span>
              <div className="max-h-12 flex items-center justify-center p-1">
                <img 
                  src={currentLogoUrl} 
      ...
      <div className="pt-2 border-t border-white/5 space-y-2">
        <label className="block text-xs font-bold text-slate-400">Ou informe uma URL web de logotipo:</label>
        <div className="flex gap-2">
          ...
          <button
            ...
            className="px-3 py-2 bg-white/5 hover:bg-white/10 text-white rounded-xl text-xs font-bold border border-white/5 transition-colors"
          >
            Aplicar URL
          </button>
        </div>
