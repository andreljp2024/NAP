...
const ITENS_HOMOLOGACAO_PADRAO: ItemHomologacao[] = [
  ...
  },
  {
    ...
    categoria: 'tecnica',
    titulo: '6. Desbloqueio Temporário (Promessa 48h)',
    subtitulo: 'Liberação emergencial de conexão com registro na auditoria',
    progresso: 100,
    status: 'concluido',
    criticidade: 'Alta',
    responsavel: 'Cobrança / Atendimento',
    detalhes: 'Disparo de comando de desbloqueio de confiança (48 horas) direto pelo Kanban de Cobrança ou via URA WhatsApp, com validação de limite de promessas por ciclo contratual.',
    passoAPasso: [
      'Localizar cliente inadimplente no Kanban de Cobrança.',
      'Clicar no botão "Desbloqueio 48h (Confiança)".',
  ...
  },
  {
    ...
    detalhes: 'Cadastrar o endpoint de webhook dentro do painel administrativo do ERP do provedor para que, assim que o banco liquidar o título, o NAP dê baixa automática no Kanban e no Portal.',
    passoAPasso: [
  ...
  },
  {
    ...
    detalhes: 'Cadastrar no painel de desenvolvedores da Meta a URL de callback do NAP (`/api/webhook/whatsapp`) para processamento em tempo real de mensagens recebidas e status de leitura.',
    passoAPasso: [
      ...
      'Inserir o Verify Token definido nas configurações do NAP e clicar em Verificar.'
    ],
  ...
  },
  {
    ...
    subtitulo: 'Telefonia FreePBX 17 / Asterisk embarcada no painel do operador',
    progresso: 100,
    status: 'concluido',
    criticidade: 'Alta',
    responsavel: 'Engenheiro de Voz / NOC',
    detalhes: 'O Webphone embarcado conecta-se via WebSockets seguros com o FreePBX 17 negociando o codec Opus, permitindo atender chamadas telefônicas diretamente pelo navegador sem softphone externo.',
    passoAPasso: [
      'Criar ramal do tipo PJSIP com transporte WSS habilitado no FreePBX.',
  ...
  // --- PILAR DE SEGURANÇA & CONFORMIDADE ---
  {
    id: 'sec-sha-audit',
    categoria: 'seguranca',
    titulo: '16. Trilha Forense com Assinatura SHA-256',
  ...
  },
  {
    id: 'sec-donut-chart',
    categoria: 'seguranca',
    titulo: '17. Gráfico de Rosca Analítico de Ações',
  ...
  },
  {
    id: 'sec-lgpd-art37',
    categoria: 'seguranca',
    titulo: '18. Conformidade LGPD Art. 37 (Registro de Operações)',
  ...
  },
  {
    ...
    categoria: 'seguranca',
    titulo: '19. Guarda de Registros (Marco Civil Art. 15)',
  ...
  },
  {
    ...
    categoria: 'seguranca',
    titulo: '20. Matriz de Controle de Acesso RBAC em 4 Níveis',
  ...
  },
  {
    ...
    categoria: 'seguranca',
    titulo: '21. Conformidade NR-17 de Teleatendimento',
  ...
  },
  {
    ...
    categoria: 'seguranca',
    titulo: '22. Rotina de Backup & Recuperação de Desastres',
  ...
  // --- PILAR DE DOCUMENTAÇÃO & OPERAÇÃO ---
  {
    ...
    titulo: '23. Manual Técnico de Arquitetura e Mapa de Portas',
  ...
  },
  {
    ...
    categoria: 'documentacao',
    titulo: '24. Guia de Integração Multi-ERP e Dicionário de APIs',
  ...
  },
  {
    ...
    categoria: 'documentacao',
    titulo: '25. Roteiro de Treinamento dos Atendentes',
  ...
  },
  {
    id: 'doc-guia-campo',
    categoria: 'documentacao',
    titulo: '26. Guia Operacional para Técnicos de Campo',
  ...
  },
  {
    ...
    categoria: 'documentacao',
    titulo: '27. Procedimento Operacional Padrão (POP) para Incidentes NOC',
  ...
  },
  {
    id: 'doc-termo-aceite',
    categoria: 'documentacao',
    titulo: '28. Termo Formal de Homologação & Aceite da Diretoria',
...
export default function ChecklistHomologacao() {
  ...
  const exportarMarkdown = () => {
    let md = `# RELATÓRIO OFICIAL DE HOMOLOGAÇÃO & GO-LIVE - NAP CRM OMNICHANNEL\n`;
    ...
    md += `---\n*Documento gerado pelo Módulo de Homologação do NAP para fins de auditoria e liberação de Go-Live.*`;
      ...
      <div className="p-6 bg-[#0b0f19] border border-white/5 rounded-3xl space-y-6 shadow-xl">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 pb-4 border-b border-white/5">
          <div>
            ...
            <h2 className="text-xl md:text-2xl font-bold text-white mt-1.5 flex items-center gap-2.5">
          ...
          <div className="flex flex-wrap items-center gap-2 shrink-0">
            ...
            <button
              ...
              className="p-2 bg-white/5 hover:bg-white/10 text-slate-400 hover:text-slate-200 rounded-xl transition-all border border-white/5"
        ...
        <div className="space-y-3">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 text-xs">
            <div className="flex items-center gap-2">
              <span className="font-bold text-white uppercase tracking-wider text-[11px]">Prontidão Geral para Go-Live:</span>
          ...
          <div className="w-full h-3.5 bg-[#06080e] rounded-full overflow-hidden p-0.5 border border-white/10 relative">
            <div 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 pt-2">
          ...
          <div 
            ...
            className={`p-4 rounded-2xl border cursor-pointer transition-all ${
              filtroCategoria === 'tecnica'
                ...
                : 'bg-[#06080e] border-white/5 hover:border-white/15'
            }`}
          >
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs font-black font-mono text-white">{metricas.tecnica.perc}%</span>
            </div>
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs font-black font-mono text-white">{metricas.seguranca.perc}%</span>
            </div>
            <div className="w-full h-1.5 bg-white/5 rounded-full overflow-hidden mt-2.5">
              <div 
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs font-black font-mono text-white">{metricas.documentacao.perc}%</span>
            </div>
            <div className="w-full h-1.5 bg-white/5 rounded-full overflow-hidden mt-2.5">
              <div 
        ...
        <div className="flex items-center gap-1.5 overflow-x-auto pb-1 md:pb-0 scrollbar-none">
          ...
          <button
            ...
            className={`px-2.5 py-1 rounded-lg text-xs font-bold transition-all ${
              filtroStatus === 'todos' ? 'bg-blue-600 text-white' : 'bg-white/5 text-slate-400 hover:text-white'
            }`}
          >
            Todos ({itens.length})
          </button>
          <button
            ...
            className={`px-2.5 py-1 rounded-lg text-xs font-bold transition-all ${
              filtroStatus === 'pendente_provedor' ? 'bg-amber-600 text-white' : 'bg-white/5 text-slate-400 hover:text-white'
            }`}
          >
          ...
          <button
            ...
            className={`px-2.5 py-1 rounded-lg text-xs font-bold transition-all ${
              filtroStatus === 'concluido' ? 'bg-emerald-600 text-white' : 'bg-white/5 text-slate-400 hover:text-white'
            }`}
          >
          ...
          <button
            ...
            className={`px-2.5 py-1 rounded-lg text-xs font-bold transition-all ${
              filtroStatus === 'bloqueantes' ? 'bg-rose-600 text-white' : 'bg-white/5 text-slate-400 hover:text-white'
            }`}
          >
        ...
        <div className="flex items-center gap-2">
          <div className="relative w-full sm:w-64">
            ...
            <input
              ...
              className="w-full pl-8 pr-3 py-1.5 bg-[#06080e] border border-white/10 rounded-xl text-xs text-white placeholder-slate-500 outline-none focus:border-blue-500 transition-all"
            />
          </div>
          ...
          <button
            ...
            className="px-2.5 py-1.5 bg-white/5 hover:bg-white/10 text-slate-300 rounded-xl text-xs font-bold transition-all shrink-0 border border-white/5"
        ...
        {itensFiltrados.map((item) => {
          ...
          return (
            ...
            >
                ...
                <div className="flex items-center justify-between lg:justify-end gap-5 shrink-0 pt-2 lg:pt-0 border-t lg:border-t-0 border-white/5">
                  ...
                  <div className="w-44 space-y-1.5">
                    <div className="flex items-center justify-between text-[11px] font-mono">
                      ...
                      <span className={`font-bold ${item.progresso === 100 ? 'text-emerald-400' : 'text-white'}`}>
                        {item.progresso}%
                      </span>
                    </div>

                    {/* Barra Visual com Código de Cores */}
                    <div className="w-full h-2 bg-[#06080e] rounded-full overflow-hidden border border-white/10 p-0.5">
                      <div 
                    ...
                    <div className="flex items-center justify-between text-[9px] font-mono text-slate-500 pt-0.5">
                      <button type="button" onClick={() => atualizarProgresso(item.id, 0)} className="hover:text-white px-1">0%</button>
                      <button type="button" onClick={() => atualizarProgresso(item.id, 50)} className="hover:text-white px-1">50%</button>
                      <button type="button" onClick={() => atualizarProgresso(item.id, 75)} className="hover:text-white px-1">75%</button>
                      <button type="button" onClick={() => atualizarProgresso(item.id, 100)} className="hover:text-white px-1 font-bold text-emerald-400">100%</button>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="text-right hidden sm:block">
                      <span className="text-[10px] text-slate-500 block uppercase tracking-wider">Responsável</span>
                      <span className="text-xs font-semibold text-slate-300 whitespace-nowrap">{item.responsavel}</span>
                    </div>
              ...
              {isExpandido && (
                <div className="p-4 sm:p-5 bg-[#06080e] border-t border-white/5 rounded-b-2xl space-y-4 text-xs">
                  ...
                  <div>
                    ...
                    <ol className="space-y-1.5 list-decimal pl-4 text-slate-300">
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-2 pt-2 border-t border-white/5">
                    <div className="flex items-center gap-2">
                      <span className="text-[11px] text-slate-400">Definir Status Manual:</span>
                      <button
                        type="button"
                        onClick={() => atualizarStatus(item.id, 'concluido')}
                        className={`px-2 py-1 rounded text-[10px] font-bold ${
                          item.status === 'concluido' ? 'bg-emerald-600 text-white' : 'bg-white/5 text-slate-400 hover:text-white'
                        }`}
                      >
                        Concluído
                      </button>
                      <button
                        ...
                        className={`px-2 py-1 rounded text-[10px] font-bold ${
                          item.status === 'em_progresso' ? 'bg-blue-600 text-white' : 'bg-white/5 text-slate-400 hover:text-white'
                        }`}
                      >
                        Em Andamento
                      </button>
                      <button
                        ...
                        className={`px-2 py-1 rounded text-[10px] font-bold ${
                          item.status === 'pendente_provedor' ? 'bg-amber-600 text-white' : 'bg-white/5 text-slate-400 hover:text-white'
                        }`}
                      >
                        Pendente Provedor
                      </button>
                      <button
                        ...
                        className={`px-2 py-1 rounded text-[10px] font-bold ${
                          item.status === 'bloqueado' ? 'bg-rose-600 text-white' : 'bg-white/5 text-slate-400 hover:text-white'
                        }`}
                      >
                        Bloqueado
                      </button>
