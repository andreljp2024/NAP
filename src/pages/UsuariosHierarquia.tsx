          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">
                1 Administrador • 1 Operador de Atendimento • 2 Técnicos de Campo • Geolocalização Ativa por Padrão
              </p>
            </div>
          </div>
        </div>
              ...
              {usuarios.filter(u => u.cargo === 'tecnico').map(tec => (
                <div key={tec.id} className="bg-[#0b0f19] border border-white/5 rounded-xl p-4 space-y-3">
                  <div className="flex items-start justify-between">
                    ...
                    <span className="flex items-center gap-1 text-[10px] bg-emerald-500/20 text-emerald-300 px-2 py-0.5 rounded-full font-bold">
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-8 bg-[#101726] border border-white/10 rounded-2xl p-5 space-y-4">
              ...
              <div className="relative w-full h-80 bg-[#070b12] rounded-xl border border-white/10 overflow-hidden flex flex-col justify-between p-4">
