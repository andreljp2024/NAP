                  ...
                  {chatHistory.map((msg, i) => (
                    <div key={i} className={`flex flex-col ${msg.role === 'user' ? 'items-end' : 'items-start'}`}>
                      ...
                      <div className="flex items-center gap-2 mt-1.5 px-1 text-[10px] text-slate-500 font-mono">
                        <span>{msg.role === 'user' ? 'Você' : 'NAP (Gemini)'}</span>
                        <span>•</span>
                  ...
                  {loading && (
                    <div className="flex items-start">
                      <div className="flex items-center gap-2 text-xs text-indigo-400 bg-indigo-500/10 border border-indigo-500/20 px-4 py-2.5 rounded-xl w-fit ">
                        <RefreshCw size={14} className="animate-spin" /> NAP está processando com o SGP...
                      </div>
                    </div>
                  )}
          ...
          {activeTab === 'channels' && (
            <div className="max-w-4xl mx-auto h-full space-y-4">
              ...
              <div className="bg-[#101726] border border-white/5 rounded-3xl p-6  flex flex-col md:flex-row gap-6 items-center hover:border-indigo-500/30 transition-all">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <h3 className="text-base font-bold text-white">Asterisk (Integração Direta NAP)</h3>
                  ...
                  <button className="text-xs bg-indigo-600 hover:bg-indigo-500 text-white px-4 py-2 rounded-lg font-bold transition-all ">
