...
export const CLIENTE_TESTE_INADIMPLENTE: PortalClient = {
  ...
  tag: "Inadimplente • Teste Desbloqueio 48h",
  badgeColor: "amber",
  descricao_cenario: "Cenário de atraso de 9 dias para validação de régua de cobrança, aviso de débito e teste do botão de Desbloqueio em Confiança de 48 horas."
};
